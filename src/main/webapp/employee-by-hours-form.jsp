...
<body>
	...
	<div>
		...
		<fieldset>
			<label>Employee Hours</label> <input type="number"
				value="<c:out value='${employee.hours}'/>" name="hours"
				required="required">
		</fieldset>
		...
		<p>
			<input type="hidden" value="EMPLOYEE_BY_HOURS" name="role"
				required="required">
		</p>

		<fieldset>
			<label>Employee Preference</label>
			<p>
		...
		<input type="hidden" min="0" max="1" step="0.01" value="0"
